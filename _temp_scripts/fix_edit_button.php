...
// 1. Remove the button from the bottom ACTION BUTTONS
$oldBottomButton = <<<EOF
            <div>
...
EOF;
$content = str_replace($oldBottomButton, "            <div></div>", $content);

// 2. Add it to the top Header
$oldHeader = <<<EOF
<!-- Header -->
...
echo "Moved hapus button to top in edit.blade.php\n";
